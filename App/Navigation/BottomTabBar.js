...
import withDimensions from '../../node_modules/react-navigation-tabs/src/utils/withDimensions';
import IconTouchable from '../Components/IconTouchable'
import Images from '../Themes/Images'
import Sizes from '../Themes/Sizes'
import {BOTTOM_BAR_HEIGHT} from '../Themes/Device'
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <TouchableWithoutFeedback
          onPress={() => onTabLongPress({route: routes[2]})}>
          <Image
            source={Images.menu}
...
const styles = StyleSheet.create({
  ...
  iconHome: {
    position: 'absolute',
    alignSelf: 'center',
    bottom: BOTTOM_BAR_HEIGHT + Sizes.width2,
