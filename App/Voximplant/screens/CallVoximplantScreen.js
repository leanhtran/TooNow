...
export default class CallVoximplantScreen extends React.Component {
  constructor(props) {
    super(props)
  ...
  muteAudio() {
    ...
    console.log('CallVoximplantScreen -> muteAudio -> isMuted', isMuted)
    ...
    return (
      <SafeAreaView style={styles.safearea}>
        ...
        <View style={styles.useragent}>
          ...
          {this.state.isKeypadVisible ? <Keypad keyPressed={e => this._keypadPressed(e)} /> : null}
