...
export default class IncomingCallVoximplantScreen extends React.Component {
      ...
      if (Platform.OS === 'android') {
        ...
        if (recordAudioGranted) {
          if (withVideo && !cameraGranted) {
            console.warn('IncomingCallVoximplantScreen: answerCall: camera permission is not granted')
            return
          }
        } else {
          console.warn('IncomingCallVoximplantScreen: answerCall: record audio permission is not granted')
          return
        }
      }
    } catch (e) {
  ...
  _onCallEndpointAdded = (event) => {
    console.log('IncomingCallVoximplantScreen: _onCallEndpointAdded: callid: ' + this.call.callId + ' endpoint id: ' + event.endpoint.id)
