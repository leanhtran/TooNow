...
const vh = height / DH
const vw = width / DW
const sizeWidth = number => number * (width < height ? vw : vh)
const sizeHeight = number => number * (width > height ? vw : vh)
const sizeFont = number => number * (width < height ? vw : vh)
...
export default {
  ...
  width0_165: sizeWidth(0.165),
  width1_5: sizeWidth(1.5),
  width1: sizeWidth(1),
  width2: sizeWidth(2),
  width3: sizeWidth(3),
  width4: sizeWidth(4),
  ...
  width350: sizeWidth(350),
  width450: sizeWidth(450),
